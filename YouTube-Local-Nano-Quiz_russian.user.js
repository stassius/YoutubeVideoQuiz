...
- Считай транскрипт неточной автоматической расшифровкой. Исправляй очевидную опечатку или ошибку распознавания только когда правильный общеупотребительный термин однозначно подтверждается темой и соседним контекстом. Не копируй искажённое слово дословно. Если исправление неочевидно — не угадывай и выбери другой факт.
...
- Проверяй написание каждого термина в prompt, options, correctAnswers и explanation. Формы одного термина должны быть согласованы, а correctAnswers не должен содержать искажённое слово, которое explanation пишет иначе.
...
Транскрипт создан распознаванием речи и может искажать термины. Исправляй только очевидные опечатки и ошибки распознавания, когда правильный общеупотребительный термин однозначен из темы и соседнего контекста. Если исправление неочевидно, пропусти сомнительное слово и не угадывай.
...
Перед JSON примени «Границу темы» к каждому кандидату. Затем сверь prompt, options, correctAnswers и explanation: они должны говорить об одном понятии и использовать правильно написанные, согласованные термины. Убедись, что каждый true_false — утверждение, а не вопрос; иначе смени его тип или замени. Все сомнительные кандидаты замени.
`.trim(),
